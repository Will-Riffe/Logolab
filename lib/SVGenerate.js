...
function SVGenerate(data = { shape: 'Square', shapecolor: 'white', textcolor: 'black', text: '' }) {
    ...
    return `
      <svg width="${width}" height="${height}" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="50%" y="55%" text-anchor="middle" fill="${data.textcolor}" font-size="${width / 2}">${data.text}</text>
        </svg>
    `;
}
